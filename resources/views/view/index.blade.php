...
<head>
    ...
    <title>template bootstrap5</title>
    <!-- animation -->
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Lora&family=Noto+Sans+Kawi&family=Roboto:ital,wght@0,100;0,300;0,400;1,100;1,300&display=swap" rel="stylesheet">
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .sec2 .head h1, .sec3 .head h1 {
                font-size: 24px;
            }

            .sec2 .row div, .sec3 .row div {
                flex-basis: 100%;
                max-width: 100%;
            }
        }
...
<nav class="navbar navbar-expand-lg sticky-top navbar-light bg-white p-0" data-aos="fade-down">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="main">
            ...
            <a class="btn rounded-pill main-btn " href="{{ route('login') }}">Login</a>
        </div>
    </div>
</nav>
            ...
            <div class="dl col-lg-6  flex-column d-flex justify-content-center text-light align-items-center  p-0">
                <div class="total flex-column d-flex justify-content-center align-items-center">
                    <div class="y flex-column d-flex">
                        <img src="{{asset('assets/img/software-removebg-preview.png')}}" class="s" alt="">
                        <img src="{{asset('assets/img/14-removebg-preview.png')}}" class="d" alt="">
                        <h1><span style="font-size: 80px;">Y</span>aku<span style="color: #b3050e; font-size: 70px;">Tech</span></h1>
                    </div>
                </div>
                ...
                <a class="btn rounded-pill main-btn " href="#" data-aos="fade-up" data-aos-duration="3000">Get Started</a>

            </div>
            <div class="dr col-lg-6 d-none d-lg-block d-flex justify-content-center p-0" data-aos="zoom-in" data-aos-delay="1000">
...
<section class="sec2 " id="sec2">
    ...
    <div class="container">
        <div class="head text-center mb4" data-aos="fade-up" data-aos-delay="100">
            ...
            <p>Lorem voluptas praesentium cum vel architecto quasi a porro? Minus doloribus <br> accusamus similique tempora voluptatibus nihil beatae.</p>

        </div>
        <div class="row">
            <div class="col-lg-6 d-flex justify-content-center align-items-center" data-aos="fade-right" data-aos-delay="500">
            ...
            <div class="col-lg-6 " >
                <div class="text-block ">
                    <div class="one mb-3" data-aos="fade-left" data-aos-delay="500">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque autem porro harum ab omnis sapiente vitae nam iusto ullam debitis minus hic blanditiis, reprehenderit eveniet nulla qui doloremque, voluptas facilis?</p>
                    </div>
...
<section class="sec3 " id="sec3">
    <div class="container">
        ...
        <div class="row p-0">
            <div class="h col-md-6 col-lg-4 d-flex flex-column mb-5 h-100"  data-aos="zoom-in" data-aos-delay="500">
            ...
            <div class="h col-md-6 col-lg-4 d-flex flex-column mb-5 h-100"  data-aos="zoom-in" data-aos-delay="700">
            ...
            <div class="h col-md-6 col-lg-4 d-flex flex-column  mb-5 h-100"  data-aos="zoom-in" data-aos-delay="1000">
                <div class="box p-4 w-100 shadow ">
            ...
            <div class="col-md-6 col-lg-4 d-flex flex-column   mb-5 h-25"  data-aos="zoom-in" data-aos-delay="500">
                <div class="box w-100 p-4 shadow ">
            ...
            <div class="col-md-6 col-lg-4 d-flex flex-column  mb-5 h-25"  data-aos="zoom-in" data-aos-delay="1000">
                <div class="box w-100 p-4 shadow ">
...
<section class="sec4" id="sec4">
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12 d-flex justify-content-center align-items " data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="col-lg-4 col-md-6 mb-4  p web all"   data-aos="zoom-in" data-aos-delay="500">
                <div class=" pro-sec" data-work="Application" >
                    ...
                    <div class="ser d-none ">
                        ...
                        <a href="https://bootstrapmade.com/demo/Append/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4  card all p"  data-aos="zoom-in" data-aos-delay="700">
                <div class="pro-sec " data-work="Application" >
                    ...
                    <div class="ser d-none ">
                        <h4>Web2</h4>
                        <p>Web2</p>
                        <a href="{{asset('assets/img/web2.png')}}" class="" title="Web3"><i class="fa-solid fa-plus"></i></a>
                        <a href="https://bootstrapmade.com/demo/Arsha/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4  web all p"  data-aos="zoom-in" data-aos-delay="1000">
                <div class="pro-sec" data-work="Application" >
                    ...
                    <div class="ser d-none ">
                        <h4>Web3</h4>
                        <p>Web3</p>
                        <a href="{{asset('assets/img/web3.png')}}" class="" title="App"><i class="fa-solid fa-plus"></i></a>
                        <a href="https://bootstrapmade.com/demo/iPortfolio/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4 p card all"  data-aos="zoom-in" data-aos-delay="500">
                <div class=" pro-sec " data-work="Application"  >
                    ...
                    <div class="ser d-none ">
                        <h4>Web4</h4>
                        <p>Web4</p>
                        <a href="{{asset('assets/img/web4.png')}}" class="" title="web4"><i class="fa-solid fa-plus"></i></a>
                        <a href="https://bootstrapmade.com/demo/Gp/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4  app all p"  data-aos="zoom-in" data-aos-delay="700">
                <div class="pro-sec "  data-work="Application">
                    ...
                    <div class="ser d-none ">
                        <h4>Web5</h4>
                        <p>Web5</p>
                        <a href="{{asset('assets/img/web5.png')}}" class="" title="App"><i class="fa-solid fa-plus"></i></a>
                        <a href="https://bootstrapmade.com/demo/Yummy/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 mb-4  app all p"  data-aos="zoom-in" data-aos-delay="1000">
                <div class=" pro-sec" data-work="Application" >
                    ...
                    <div class="ser d-none ">
                        <h4>Web6</h4>
                        <p>Web6</p>
                        <a href="{{asset('assets/img/web7.png')}}" class="" title="App"><i class="fa-solid fa-plus"></i></a>
                        <a href="https://bootstrapmade.com/demo/Logis/" class="" title="More Details"><i class="fa-solid fa-link"></i></a>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-5"  data-aos="fade-right" data-aos-delay="500">
                <div class="contact d-flex flex-md-column justify-content-between pb-3 justify-content-md-center  align-items-start gap-4">
                    <div class="cont">
                        <div class="icon d-flex align-items-baseline">
            ...
            <div class="col-lg-7 d-flex justify-content-center align-items-center"  data-aos="fade-left" data-aos-delay="500">
